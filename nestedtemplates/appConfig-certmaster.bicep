...
resource appServiceName_appsettings 'Microsoft.Web/sites/config@2024-04-01' = {
  ...
  properties: {
    ...
    '${convertVariableNameToLinux('AppConfig:LoggingConfig:AzureOfferingDomain', deployOnLinux)}': 'azure.cn'
    '${convertVariableNameToLinux('AppConfig:AzureCloudConfig:AzureADEndpoint', deployOnLinux)}': environment().authentication.loginEndpoint
    '${convertVariableNameToLinux('AppConfig:AzureCloudConfig:MSGraphEndpoint', deployOnLinux)}': 'https://microsoftgraph.chinacloudapi.cn'
    '${convertVariableNameToLinux('AppConfig:AzureCloudConfig:KeyVaultEndpoint', deployOnLinux)}': 'https://${environment().suffixes.keyvaultDns}'
    '${convertVariableNameToLinux('AppConfig:AzureCloudConfig:ManagementEndpoint', deployOnLinux)}': 'https://api.manage.microsoft.cn'
  }
}
